...
describe('for generic', () => {
   describe('interface', () => {
       ...
       it('should set the value for one generic with Generics', () => {
           ...
           const properties: GenericOneValue<GenericOneValue<string>> = createMock<GenericOneValue<GenericOneValue<string>>>();
       ...
       it('should set the value for one generic with Generics default', () => {
           ...
           const properties: GenericOneValue<GenericDefault> = createMock<GenericOneValue<GenericDefault>>();
       ...
       it('should set the value for one generic with Generics sub generic', () => {
           ...
           const properties: GenericOneValue<WithSubGeneric<string>> = createMock<GenericOneValue<WithSubGeneric<string>>>();
