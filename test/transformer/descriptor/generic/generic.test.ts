...
describe('for generic', () => {
  describe('interface', () => {
    ...
    it('should set the value for one generic', () => {
      const properties: GenericOneValue<number> =
        createMock<GenericOneValue<number>>();
    ...
    it('should set the value for one generic reusing', () => {
      const properties: GenericOneValue<number> =
        createMock<GenericOneValue<number>>();
      const properties2: GenericOneValue<string> =
        createMock<GenericOneValue<string>>();
    ...
    it('should set the value for multiple generics', () => {
      const properties: GenericTwoValues<number, string> =
        createMock<GenericTwoValues<number, string>>();
    ...
    it('should set the value for default generics when provided', () => {
      const propertiesWithGeneric: GenericDefault<number> =
        createMock<GenericDefault<number>>();

      expect(propertiesWithGeneric.a).toBe(0);
    });

    it('should set the value for default generics when not provided', () => {
      const propertiesWithGeneric: GenericDefault =
        createMock<GenericDefault>();

      expect(propertiesWithGeneric.a).toBe('');
    });

    it('should set the value for default generics when not provided as second', () => {
      const propertiesWithoutGeneric: GenericDefaultSecond<number> =
        createMock<GenericDefaultSecond<number>>();
      const propertiesWithGeneric: GenericDefaultSecond<string, string> =
    ...
    it('should set the value only default generics when not provided', () => {
      ...
      const propertiesWithGeneric: Generic<number> =
        createMock<Generic<number>>();
    ...
    it('should set the value for interfaces', () => {
      ...
      const propertiesWithGeneric: Generic<StandardInterface> =
        createMock<Generic<StandardInterface>>();
    ...
    it('should set the value of the sub generics', () => {
      const properties: WithSubGeneric<string> =
        createMock<WithSubGeneric<string>>();
    ...
    it('should set the value of the sub generics', () => {
      const properties: WithSubGenericInverted<number> =
        createMock<WithSubGenericInverted<number>>();
    ...
    it('should set the value for child generics', () => {
      ...
      const properties: UseGeneric<number, string> =
        createMock<UseGeneric<number, string>>();
      const properties2: UseGeneric<string, number> =
        createMock<UseGeneric<string, number>>();
    ...
    it('should set the value for one generic with Generics', () => {
      ...
      const properties: GenericOneValue<GenericOneValue<string>> =
        createMock<GenericOneValue<GenericOneValue<string>>>();
    ...
    it('should set the value for one generic with Generics default', () => {
      ...
      const properties: GenericOneValue<GenericDefault> =
        createMock<GenericOneValue<GenericDefault>>();
    ...
    it('should set the value for one generic with Generics sub generic', () => {
      ...
      const properties: GenericOneValue<WithSubGeneric<string>> =
        createMock<GenericOneValue<WithSubGeneric<string>>>();
    ...
    it('should set the value in sub interfaces', () => {
      ...
      const properties: InterfaceWithThis<string> =
        createMock<InterfaceWithThis<string>>();
    ...
    it('should set the value for type generic', () => {
      ...
      const propertiesWithGeneric: InterfaceWithCallSignature<number, string> =
  ...
  describe('classes', () => {
    ...
    it('should set all the generics', () => {
      const properties: WithGenerics<string, number> =
        createMock<WithGenerics<string, number>>();
      expect(properties.iAmANumber).toBe(0);
      expect(properties.iAmAString).toBe('');
    });

    it('should set all the sub generics', () => {
      const properties: WithGenericsSub<string> =
        createMock<WithGenericsSub<string>>();
      expect(properties.sub.iAmAString).toBe('');
      expect(properties.iAmAString).toBe('');
    });

    it('should set all the generics with sub interfaces', () => {
      const properties: WithGenericsSubInterface<string> =
        createMock<WithGenericsSubInterface<string>>();
      expect(properties.sub.iAmAString).toBe('');
    });
  });
