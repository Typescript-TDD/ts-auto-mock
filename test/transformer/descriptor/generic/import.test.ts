...
describe('for generic', () => {
  describe('interfaces', () => {
    it('should set all the default values with import interfaces', () => {
      const properties: ImportWithGenerics<string> =
        createMock<ImportWithGenerics<string>>();
  ...
  describe('classes', () => {
    it('should set all the default values with import classes', () => {
      const properties: ClassGenerics<string> =
        createMock<ClassGenerics<string>>();
      expect(properties.a).toBe('');
  ...
  describe('types', () => {
    it('should set all the default values with import type', () => {
      const properties: TypeGenerics<string> =
        createMock<TypeGenerics<string>>();
      expect(properties.a).toBe('');
    });
  });
});
