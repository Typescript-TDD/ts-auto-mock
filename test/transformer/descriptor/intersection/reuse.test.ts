...
describe('for generic reuse', () => {
  ...
  it('should assign the correct value', () => {
    const mockString: Interface<string, number> = createMock<Interface<string, number>>();
    const mockNumber: Interface<number, string> = createMock<Interface<number, string>>();
    const mockStringAgain: Interface<string, number> = createMock<Interface<string, number>>();
