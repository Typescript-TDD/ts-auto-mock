export {};
export declare type Mock<T> = T extends (() => infer TR) ? MockMethod<TR> : T extends (...args: any[]) => infer TR ? MockArgsMethod<TR> : T extends Function ? MockMethod<any> : T extends Array<infer TE> ? MockArray<TE> : T extends Number | String | Boolean ? T : T extends object ? MockObject<T> : T;
